...
# ---------------------------------------
##if mcok:
##    from minecraft/Magic_Wand/Functions import Bridge
##    from minecraft/Magic_Wand/Functions import House
##    from minecraft/Magic_Wand/Functions import Midas
##    from minecraft/Magic_Wand/Functions import Mine
